...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libTimer = __webpack_require__(157);
	...
	_react2['default'].render(_react2['default'].createElement(_libTimer2['default'], { options: OPTIONS }), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SecondsTohhmmss = __webpack_require__(158);
	...
	var Timer = _react2['default'].createClass({
	  ...
	  **/
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement('div', { style: timerStyle, className: 'react-timer' }, _react2['default'].createElement('h3', { style: secondsStyles, className: 'seconds' }, ' ', this.state.time, ' ', this.props.prefix), _react2['default'].createElement('br', null), _react2['default'].createElement('button', { onClick: this.reset, style: buttonStyle }, 'reset'), _react2['default'].createElement('button', { onClick: this.play, style: buttonStyle }, 'play'), _react2['default'].createElement('button', { onClick: this.pause, style: buttonStyle }, 'pause'));
	  }
	});
